...
const Mondai = dynamic(() => import('@/components/jlpt/read/Mondai'), {
  ssr: false,
});
const Mondai7 = dynamic(() => import('@/components/jlpt/read/Mondai7'), {
  ssr: false,
});
const Mondai8 = dynamic(() => import('@/components/jlpt/read/Mondai8'), {
  ssr: false,
});
const Mondai9 = dynamic(() => import('@/components/jlpt/read/Mondai9'), {
  ssr: false,
});
const Mondai10 = dynamic(() => import('@/components/jlpt/read/Mondai10'), {
  ssr: false,
});
const Mondai11 = dynamic(() => import('@/components/jlpt/read/Mondai11'), {
  ssr: false,
});
const Mondai12 = dynamic(() => import('@/components/jlpt/read/Mondai12'), {
  ssr: false,
});
const Mondai13 = dynamic(() => import('@/components/jlpt/read/Mondai13'), {
  ssr: false,
});
...
export default async function JLPTDetail({ params }: Props) {
  ...
  const getMondai = (mondaiNumber: number) => {
    const mondai = mondais.filter(
      (value) => value.mondai_number === mondaiNumber
    );
    const question = questions.filter(
