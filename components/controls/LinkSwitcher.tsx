...
//         className={`${
//           hiddenMenu && 'hidden'
//         } z-10 items-center justify-between w-full fixed top-0 right-0 md:flex md:w-auto md:order-1 md:relative`}
  ...
  return (
    <>
      <div
        ...
        } transition-transform duration-300 ease-in-out fixed top-0 right-0 z-10 w-full md:flex md:w-auto md:order-1 md:relative bg-gray-200 border border-gray-100 md:bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700`}
        onClick={() => setHiddenMenu(!hiddenMenu)}
      >
        ...
        <div className="absolute md:hidden top-4 right-4 p-4">
          <FiX onClick={() => setHiddenMenu(!hiddenMenu)} />
        </div>
      </div>
