...
export default function LocaleSwitcher() {
  ...
  return (
    <div className="w-32 relative flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
      ...
      <div
        className={`w-full z-10 absolute top-full mt-2 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 transform transition-transform duration-300 ${
          isDropdownOpen
            ? 'translate-y-0 ease-out opacity-100'
            : 'hidden translate-y-4 ease-in opacity-0'
        }`}
